...
public sealed class CodexAppServerClient : IAgentClient
{
    ...
    public async Task ConnectAsync(string endpoint, CancellationToken cancellationToken)
    {
        ...
        {
            ["clientInfo"] = new JObject { ["name"] = "boneai", ["title"] = "BoneAI", ["version"] = "3.3.0" },
