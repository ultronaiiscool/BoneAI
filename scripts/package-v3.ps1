...
foreach ($name in @('README.md', 'QUEST-README.md', 'INSTALL-FIRST.md', 'CHANGELOG.md', 'RELEASE-v3.1.1.md', 'LICENSE', 'manifest.json', 'icon.png')) {
...
Copy-Item -LiteralPath (Join-Path $repo 'docs/TESTING-v3.1.1.md') -Destination (Join-Path $target 'TESTING-v3.1.1.md')
